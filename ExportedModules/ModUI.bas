...
Sub CreateGameSheet()
    ...
    Range(Cells(PFX - 1, PFY - 1), Cells(PFX - 1, PFY + PFW)).Interior.Color = PFBNC
    Range(Cells(PFX + PFH, PFY - 1), Cells(PFX + PFH, PFY + PFW)).Interior.Color = PFBNC
    Range(Cells(PFX - 1, PFY - 1), Cells(PFX + PFH, PFY - 1)).Interior.Color = PFBNC
    Range(Cells(PFX - 1, PFY + PFW), Cells(PFX + PFH, PFY + PFW)).Interior.Color = PFBNC
